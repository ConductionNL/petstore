 ...
 *
 * Visual-regression baselines for Petstore's key surfaces (GAP-5).
 *
...
const APP = '/index.php/apps/petstore'

test.describe('Petstore — visual baselines', () => {
	test('dashboard', async ({ page }) => {
		await shootSurface(page, `${APP}/#/`, 'dashboard.png')
	})

	test('examples list', async ({ page }) => {
		await shootByNav(page, `${APP}/#/`, 'Examples', 'examples.png')
	})
})

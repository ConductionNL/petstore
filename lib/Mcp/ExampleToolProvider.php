...
/**
 * PetStore MCP Tool Provider (example / copy-me starting point)
 *
 ...
 *  3. Namespace every tool id `{appId}.{toolName}` (e.g. `petstore.ping`).
...
class ExampleToolProvider extends AbstractToolHandler implements IMcpToolProvider
{
     ...
     *
     * @param string               $toolId    The tool id (e.g. "petstore.ping")

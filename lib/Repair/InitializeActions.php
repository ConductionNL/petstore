...
class InitializeActions implements IRepairStep
{
    ...
    public function run(IOutput $output): void
    {
        ...
        if (file_exists(self::SEED_PATH) === false) {
            ...
            $this->logger->warning('[petstore] ADR-023 seed file missing at '.self::SEED_PATH);
            return;
        }
        ...
        try {
            ...
            $this->logger->error('[petstore] ADR-023 seed malformed: '.$e->getMessage());
            return;
        }
